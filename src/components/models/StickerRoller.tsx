...
Command: npx gltfjsx@6.5.3 sticker_roller_4.glb -t 
*/
...
// import alphaTextureUrl from '../../assets/toilet_1_texture_new_alpha_white.png'
...
function StickerRoller1({ sticker, onPeelComplete, ...props }: StickerRollerProps) {
  ...
  // const alphaTexture = useTexture(alphaTextureUrl, (txt) => { txt.flipY = false })
